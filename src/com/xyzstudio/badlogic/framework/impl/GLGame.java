...
import com.xyzstudio.badlogic.framework.Audio;
import com.xyzstudio.badlogic.framework.FileIO;
import com.xyzstudio.badlogic.framework.Game;
import com.xyzstudio.badlogic.framework.Graphics;
import com.xyzstudio.badlogic.framework.Screen;
import com.xyzstudio.badlogic.framework.impl.AndroidAudio;
...
public abstract class GLGame extends Activity implements Game, Renderer {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        input = new SensorFusionInput(this, glView, 1, 1);
    ...
    public void onDrawFrame(GL10 gl) {                
        ...
        if(state == GLGameState.Running) {
            float deltaTime = (System.nanoTime()-startTime) * CommonDefine.NS2S;
    ...
    @Override
    public SensorFusionInput getInput() {
        return input;
    }
