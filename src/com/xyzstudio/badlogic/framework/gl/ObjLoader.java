...
public class ObjLoader {
	public static Vertices3 load(GLGame game, String file) {
		return load(game.getGLGraphics(), game.getFileIO(), file);
	}
	public static Vertices3 load(GLGraphics glGraphics, FileIO fileIO, String file) {
		InputStream in = null;
		try {
			...
			Vertices3 model = new Vertices3(glGraphics, numFaces * 3,
